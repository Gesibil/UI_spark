...
from PyQt5.QtWidgets import QWidget, QApplication, QVBoxLayout, QSlider, QHBoxLayout, QPushButton
...
class MyViz( QWidget ):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("background-color: #000814;")
        ...
        thickness_slider.setStyleSheet("color: white;")
        ...
        side_button.setStyleSheet("color: white;")

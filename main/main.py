...
battery_images = {
    0: "/home/spark/TurtleUI-master/main/image_logo/discharging_0.png",
    10: "/home/spark/TurtleUI-master/main/image_logo/discharging_10.png",
    20: "/home/spark/TurtleUI-master/main/image_logo/discharging_20.png",
    30: "/home/spark/TurtleUI-master/main/image_logo/discharging_30.png",
    40: "/home/spark/TurtleUI-master/main/image_logo/discharging_40.png",
    50: "/home/spark/TurtleUI-master/main/image_logo/discharging_50.png",
    60: "/home/spark/TurtleUI-master/main/image_logo/discharging_60.png",
    70: "/home/spark/TurtleUI-master/main/image_logo/discharging_70.png",
    80: "/home/spark/TurtleUI-master/main/image_logo/discharging_80.png",
    90: "/home/spark/TurtleUI-master/main/image_logo/discharging_90.png",
    100: "/home/spark/TurtleUI-master/main/image_logo/discharging_100.png"
}
...
class Ui_MainWindow(object):
    ...
    def update_battery(self):
        ...
        battery_percent = 60#int(re.findall(r'\d+%', output.decode())[0].strip('%'))
    ...
    def setupUi(self, MainWindow):
        ...
        self.logoLabel = QtWidgets.QLabel(self.Base)
        self.logoLabel.setGeometry(QtCore.QRect(0, 0, 120, 120))
        self.logoLabel.setPixmap(QtGui.QPixmap("/home/spark/TurtleUI-master/main/image_logo/logo&.png"))
        self.logoLabel.setMaximumSize(120, 120)
        self.logoLabel.setScaledContents(True)
        self.gridLayout = QtWidgets.QGridLayout(self.logoLabel)
        ...
        self.homeButton.setGeometry(QtCore.QRect(5, 140, 110, 70))
        ...
        self.Line1 = QtWidgets.QFrame(self.Base)
        self.Line1.setGeometry(QtCore.QRect(0, 210, 120, 2))
        self.Line1.setStyleSheet("background: #1DDED8;")
        ...
        self.dataButton.setGeometry(QtCore.QRect(5, 230, 110, 70))
        ...
        self.Line2 = QtWidgets.QFrame(self.Base)
        self.Line2.setGeometry(QtCore.QRect(0, 300, 120, 2))
        self.Line2.setStyleSheet("background: #1DDED8;")
        ...
        self.adhocButton.setGeometry(QtCore.QRect(5, 310, 110, 70))
        ...
        self.Line3 = QtWidgets.QFrame(self.Base)
        self.Line3.setGeometry(QtCore.QRect(0,390, 120, 2))
        self.Line3.setStyleSheet("background: #1DDED8;")
        ...
        self.configButton.setGeometry(QtCore.QRect(5, 400, 110, 70))
        self.configButton.setStyleSheet("background: rgba(29, 222, 216, 0.1);\n"
                                       "color: white;")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/newPrefix/Config.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.configButton.setIcon(icon3)
        self.configButton.setIconSize(QtCore.QSize(55, 55))
        self.configButton.setObjectName("configButton")
        self.configButton.setToolTip('Configure Enviroment and System Variables')
        self.configButton.clicked.connect(settings)

        #line
        self.Line4 = QtWidgets.QFrame(self.Base)
        self.Line4.setGeometry(QtCore.QRect(0,490, 120, 2))
        self.Line4.setStyleSheet("background: #1DDED8;")
        self.Line4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.Line4.setFrameShape(QtWidgets.QFrame.HLine)
        self.Line4.setObjectName("Line4")

        # emergency button
        self.EmergencyButton = QtWidgets.QPushButton(self.Base)
        self.EmergencyButton.setGeometry(QtCore.QRect(5, 510, 110, 80))
        self.EmergencyButton.setStyleSheet("color: white;\n"
                                        "background: rgba(41, 63, 71, 0.75);")
        icon4 = QtGui.QPixmap("/home/spark/TurtleUI-master/main/image_logo/stop.png")
        self.EmergencyButton.setIcon(QtGui.QIcon(icon4))
        self.EmergencyButton.setIconSize(QtCore.QSize(110, 110))
        self.EmergencyButton.setObjectName("Emergency")
        self.EmergencyButton.setToolTip('shut down robot!')
        self.EmergencyButton.clicked.connect(self.EmergencyButtonstate)
        self.EmergencyButton.setFlat(True)

        # orangelogo
        self.orangelabel = QtWidgets.QLabel(self.Base)
        self.orangelabel.setGeometry(QtCore.QRect(1060, 10, 120, 120))
        self.orangelabel.setPixmap(QtGui.QPixmap("/home/spark/TurtleUI-master/main/image_logo/orange.png"))
        self.orangelabel.setMaximumSize(120, 120)
        self.orangelabel.setScaledContents(True)
        
        # Spark
        self.sparklabel = QtWidgets.QLabel(self.Base)
        self.sparklabel.setGeometry(QtCore.QRect(1180, 30, 80, 80))
        self.sparklabel.setPixmap(QtGui.QPixmap("/home/spark/TurtleUI-master/main/image_logo/spark.png"))
        self.sparklabel.setMaximumSize(120, 120)
        self.sparklabel.setScaledContents(True)
        ...
        #                               "background: rgba(41, 63, 71, 0.75);")
        # icon4 = QtGui.QIcon()
        # icon4.addPixmap(QtGui.QPixmap("/home/spark/TurtleUI-master/main/image_logo/orange.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        # self.logoButton.setGeometry(QtCore.QRect(10, 500, 100, 50))
        ...
        # self.logoButton.clicked.connect(self.OrangeClick)
        # Design de Linhas
        ...
        self.LateraLine.setGeometry(QtCore.QRect(1061, 0, 2, 700))
        ...
        self.mainControlFrame.setGeometry(QtCore.QRect(125, 10, 318, 101))
        ...
        self.mainControlFrame.setObjectName("mainControl")
        self.mainTextLabel = QtWidgets.QLabel(self.mainControlFrame)
        self.mainTextLabel.setGeometry(QtCore.QRect(103, 5, 120, 16))
        ...
        self.mainLineFrame.setGeometry(QtCore.QRect(98, 20, 120, 1))
        ...
        self.playButton.setGeometry(QtCore.QRect(25, 30, 70, 21))
        ...
        self.resetMainButton.setGeometry(QtCore.QRect(150, 38, 91, 23))
        ...
        self.reloadMainButton.setGeometry(QtCore.QRect(150, 72, 91, 23))
        ...
        self.mainLeftLineFrame.setGeometry(QtCore.QRect(150, 38, 2, 50))
        ...
        self.mainRightLineFrame.setGeometry(QtCore.QRect(240, 38, 2, 50))
        ...
        #batteryFrame
        self.batteryFrame=QtWidgets.QFrame(self.Base)
        self.batteryFrame.setGeometry(QtCore.QRect(457, 10, 318, 101))
        self.batteryFrame.setStyleSheet("background: rgba(29, 222, 216, 0.1);")
        self.batteryFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.batteryFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.batteryFrame.setObjectName("batteryFrame")

        self.batteryTextLabel = QtWidgets.QLabel(self.batteryFrame)
        self.batteryTextLabel.setGeometry(QtCore.QRect(96, 5, 110, 16))
        self.batteryTextLabel.setStyleSheet("background: transparent;\n"
                                                "color: white;")
        self.batteryTextLabel.setObjectName("batteryTextLabel")
        self.batteryLine = QtWidgets.QFrame(self.batteryFrame)
        self.batteryLine.setGeometry(QtCore.QRect(90, 20, 130, 1))
        self.batteryLine.setStyleSheet("background: #1DDED8;")
        self.batteryLine.setFrameShape(QtWidgets.QFrame.HLine)
        self.batteryLine.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.batteryLine.setObjectName(" BATTERY STATE  ")
        
        


        self.batteryState = QtWidgets.QLabel(self.batteryFrame)
        self.batteryState.setGeometry(QtCore.QRect(55, 30, 120, 70))
        pixmap,percent = self.update_battery()
        ...
        batpercent=percent
        self.batteryPercent=QtWidgets.QLabel(self.batteryFrame)
        self.batteryPercent.setGeometry(QtCore.QRect(220, 35, 60, 60))
        self.batteryPercent.setStyleSheet("background: rgba(29, 222, 216, 0.1);\n"
                                                "color: #1DDED8;font-weight: bold; font-size: 25px;")

        self.batteryLine.setObjectName("BatteryPercent")
       ...
       #create a cameraframe *******************************
        self.Gifframe = QtWidgets.QFrame(self.Base)
        self.Gifframe.setGeometry(QtCore.QRect(125, 130, 930, 467))
        self.Gifframe.setStyleSheet("background: rgba(29, 222, 216, 0.1);")
        self.Gifframe.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.Gifframe.setFrameShadow(QtWidgets.QFrame.Raised)
        self.Gifframe.setObjectName("Cameraframe")

        self.labelgif = QtWidgets.QLabel(self.Gifframe)
        self.labelgif.setGeometry(QtCore.QRect(0, 0, 930, 467))
        self.labelgif.setScaledContents(True)

        # Loading the GIF
        self.movie = QMovie("/home/spark/TurtleUI-master/main/image_logo/eyes.gif")
        ...
        # self.timer = QtCore.QTimer(self.Base)
        ...
        self.valuesFrame.setGeometry(QtCore.QRect(788, 10, 270, 101))
        ...
        self.velocityValue.setGeometry(QtCore.QRect(190, 33, 51, 20))
        self.velocityValue.setObjectName("velocityValue")
        self.velocityLabel = QtWidgets.QLabel(self.valuesFrame)
        self.velocityLabel.setGeometry(QtCore.QRect(120, 35, 111, 16))
        ...
        self.Line4.raise_()
        self.orangelabel.raise_()
        self.EmergencyButton.raise_()
    ...
    def update_frame(self):
        ...
        if ret:
            ...
            scaled_pixmap = pixmap.scaled(label_size, QtCore.Qt.KeepAspectRatio)
    ...
    def retranslateUi(self, MainWindow,percent):
        ...
        self.adhocButton.setText(_translate("MainWindow", "Connex"))
        self.configButton.setText(_translate("MainWindow", "Config"))
        #self.EmergencyButton.setText(_translate("MainWindow", "Emergency"))
        #self.orangelabel.setText(_translate("MainWindow", "orange"))
        ...
        self.batteryTextLabel.setText(_translate("MainWindow", "BATTERY STATE"))
        self.batteryPercent.setText(_translate("MainWindow"," "+str(percent)+"%"))
